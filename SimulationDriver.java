...
public class SimulationDriver {
	...
	public static void main(String args[]) {
		...
		Team vikings = new Team(0, 0, "Vikings");
		Team bears = new Team(0, 0, "Bears");
		Team packers = new Team(0, 0, "Packers");
		Team lions = new Team(0, 0, "Lions");
		nfcNorth.addTeam(vikings);
		nfcNorth.addTeam(bears);
		nfcNorth.addTeam(packers);
		nfcNorth.addTeam(lions);
		
		Team saints = new Team(0, 0, "Saints");
		Team buccaneers = new Team(0, 0, "Buccaneers");
		Team ravens = new Team(0, 0, "Ravens");
		Team panthers = new Team(0, 0, "Panthers");
		...
		System.out.println(firstSeason.getStandingsString(NFC));
		System.out.println(firstSeason.getPlayoffSeeds(NFC));
